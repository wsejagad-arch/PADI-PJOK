...
<head>
  ...
  <title>Pantau Siswa – PADI-PJOK</title>
...
<body>
  <header class="topbar">
    ...
    <div class="topbar-title">Pantau Siswa</div>
    <div class="topbar-spacer"></div>
  </header>
  <main class="content">
    <div class="card">
      <h2>Pantau Siswa Terhubung</h2>
      <p>Lihat status siswa yang sedang aktif di sesi kelas, progres kognitif, dan pengumpulan video secara langsung.</p>
      <div style="padding: 20px; border: 2px dashed var(--border); border-radius: var(--radius-sm); color: var(--text-3); font-size: 12px;">Data siswa akan muncul di sini saat sesi dimulai.</div>
    </div>
  </main>
</body>
</html>
