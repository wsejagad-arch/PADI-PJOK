...
<head>
  ...
  <title>Aktivitas – PADI-PJOK</title>
...
<body>
  <header class="topbar">
    ...
    <div class="topbar-title">Aktivitas</div>
    <div class="topbar-spacer"></div>
  </header>
  <main class="content">
    <div class="card">
      <h2>Aktivitas Harian</h2>
      <p>Linimasa dan catatan aktivitas sesi kelas yang telah dan akan Anda laksanakan.</p>
    </div>
  </main>
  ...
  <nav class="nav-bottom">
    ...
    <a href="aktivitas-guru.php" class="nav-item active" id="nav-aktivitas" aria-label="Aktivitas">
