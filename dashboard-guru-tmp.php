...
<head>
  ...
  <title>Dashboard Guru â€“ PADI-PJOK</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* â”€â”€â”€ Active session card â”€â”€â”€ */
    .session-card {
      background: var(--white);
    ...
    /* â”€â”€â”€ Progress Penilaian â”€â”€â”€ */
    .progress-grid {
      display: flex;
      gap: 8px;
      overflow-x: auto;
...
<header class="topbar" role="banner">
  ...
  <button class="notif-btn" id="notif-btn" aria-label="Notifikasi" onclick="showToast('3 notifikasi baru')">
    ...
    <span class="notif-dot" aria-label="3 notifikasi baru"></span>
  </button>
</header>
...
<main class="content" id="beranda-panel">
  ...
  <div class="stats-row anim-2" role="region" aria-label="Statistik hari ini">
    ...
    <div class="stat-card">
      ...
      <span class="stat-value yellow">72%</span>
    </div>
  </div>

  <!-- â”€â”€â”€ Aksi Cepat â”€â”€â”€ -->
  <div class="section anim-3">
    ...
    <div class="actions-grid">
      ...
      <a href="#" class="action-btn" id="btn-sesi" onclick="showToast('Mulai Sesi Baru'); return false;">
      ...
      <a href="#" class="action-btn" id="btn-pantau" onclick="showToast('Pantau Siswa'); return false;">
      ...
      <a href="#" class="action-btn" id="btn-laporan" onclick="showToast('Laporan'); return false;">
      ...
      <a href="#" class="action-btn" id="btn-rubrik" onclick="showToast('Rubrik Platform'); return false;">
  ...
  <!-- â”€â”€â”€ Sesi Aktif â”€â”€â”€ -->
  <div class="section anim-4">
    <h2 class="section-title">Sesi Aktif Hari Ini</h2>
    <div class="session-card">
      <div class="session-top">
        <img class="session-img" src="volleyball_session.png" alt="Bola voli" />
        <div class="session-info">
          <p class="session-meta-label">Materi</p>
          <p class="session-title">Passing Bawah Bola Voli</p>
          <div class="session-meta">
            <div class="meta-row">
              <span class="meta-key">Kelas</span>
              <span class="meta-val">X-1</span>
            </div>
            <div class="meta-row">
              <span class="meta-key">Kelas</span>
              <span class="meta-val">X-1</span>
            ...
            <div class="meta-row">
              ...
              <span class="meta-val" style="color:var(--blue);letter-spacing:1px;">VOLI-X1-482</span>
            </div>
          </div>
        </div>
  ...
  <div class="section anim-5">
    ...
    <div class="progress-grid" role="region" aria-label="Progress penilaian siswa">
      ...
      <div class="progress-card">
        ...
        <p class="progress-counts"><strong>22</strong>/28 siswa selesai</p>
        <div class="progress-bar-wrap">
          <div class="progress-bar-fill" style="width:79%;background:var(--blue);" data-width="79"></div>
        </div>
        <span class="progress-pct" style="color:var(--blue)">79%</span>
      </div>
      ...
      <div class="progress-card">
        ...
        <p class="progress-counts"><strong>18</strong>/28 video terkumpul</p>
        <div class="progress-bar-wrap">
          <div class="progress-bar-fill" style="width:64%;background:var(--green);" data-width="64"></div>
        </div>
        <span class="progress-pct" style="color:var(--green)">64%</span>
      </div>
      ...
      <div class="progress-card">
        ...
        <p class="progress-counts"><strong>20</strong>/28 data masuk</p>
        <div class="progress-bar-wrap">
          <div class="progress-bar-fill" style="width:71%;background:var(--pink);" data-width="71"></div>
        </div>
        <span class="progress-pct" style="color:var(--pink)">71%</span>
      </div>
      ...
      <div class="progress-card">
        ...
        <p class="progress-counts"><strong>14</strong> siswa selesai</p>
        <div class="progress-bar-wrap">
          <div class="progress-bar-fill" style="width:50%;background:var(--orange);" data-width="50"></div>
        </div>
        <span class="progress-pct" style="color:var(--orange)">50%</span>
      </div>
      ...
      <div class="progress-card">
        ...
        <p class="progress-counts"><strong>12</strong> siswa selesai</p>
        <div class="progress-bar-wrap">
          <div class="progress-bar-fill" style="width:43%;background:var(--purple);" data-width="43"></div>
        </div>
        <span class="progress-pct" style="color:var(--purple)">43%</span>
      </div>
  ...
  <div class="section anim-6">
    ...
    <div class="tugas-grid">
      <a href="#" class="tugas-item" id="tugas-video" onclick="showToast('8 video perlu dicek'); return false;">
      ...
      <a href="#" class="tugas-item" id="tugas-feedback" onclick="showToast('8 feedback belum diberikan'); return false;">
        ...
        <div class="tugas-info">
          ...
          <p class="tugas-count orange">8</p>
        </div>
        <span class="tugas-arrow" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
        </span>
      </a>
      <a href="#" class="tugas-item" id="tugas-laporan" onclick="showToast('1 laporan siap diunduh'); return false;">
...
<nav class="bottom-nav" role="navigation" aria-label="Navigasi utama">
  <a href="#" class="nav-item active" id="nav-beranda" onclick="setNav('beranda'); return false;" aria-label="Beranda" aria-current="page">
  ...
  <a href="#" class="nav-item" id="nav-aktivitas" onclick="setNav('aktivitas'); return false;" aria-label="Aktivitas">
    <div class="nav-indicator"></div>
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
  ...
  <a href="#" class="nav-item" id="nav-nilai" onclick="setNav('nilai'); return false;" aria-label="Nilai">
    <div class="nav-indicator"></div>
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
  ...
  <a href="#" class="nav-item" id="nav-profil" onclick="setNav('profil'); return false;" aria-label="Profil">
    <div class="nav-indicator"></div>
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
...
<script>
  ...
  /* â”€â”€ Animate progress bars on scroll â”€â”€ */
