...
<body>
  <header class="topbar">
    ...
    <div class="topbar-title">Nilai</div>
    <div class="topbar-spacer"></div>
  </header>
  <main class="content">
    <div class="card">
      <h2>Rekapitulasi Nilai</h2>
      <p>Pantau seluruh nilai kelas dari berbagai sesi di satu tempat terpusat.</p>
    </div>
  </main>
  ...
  <nav class="nav-bottom">
    ...
    <a href="nilai-guru.php" class="nav-item active" id="nav-nilai" aria-label="Nilai">
